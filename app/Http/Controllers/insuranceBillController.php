...
class insuranceBillController extends Controller
{
    public function index()
    {
         ...
         // die();
           if ($response->successful()) {
             ...
             return view('user.insuranceBill.index', compact('billers'));
           } else {
...
$macAddress="00-15-5D-6D-D3-36";
    ...
    public function insuranceRechargePay(Request $request)
{
...
private function updateCustomerBalance($mobile,$role,$externalRef)
{
    ...
    DB::table('getcommission')->insert([
        ...
        'service' => 'Insurance Pay',
        'sub_services' => 'Insurance Pay',
        'externalRef' =>$externalRef,
        'amount'=>$txnAmount,
        'commission' => $retailerCommission,
        'tds' => $tds,
    ...
    if ($superDistributor && $superEarning > 0) {
     ...
     $apiBalance = ApiHelper::decreaseBalance(env('Business_Email'), $realAmount, 'Insurance Pay');
//     dd([
