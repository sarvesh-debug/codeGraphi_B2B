            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg" style="background: linear-gradient(to right, #0a22aa, #b62512); color: white; border: none;">
                        <strong style="color: white;">Electricity Bill</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('electricityBillFetch')}}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label for="consumer-number" class="block text-sm font-medium">Consumer Number *</label>
                ...
                <div class="bg-white shadow-lg rounded-lg">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-500">
                            Any discrepancies in the bill amount or due date should be resolved with the respective electricity board.</p>
                            @if (session('data'))
                            ...
                            <form action="{{route('electricityBillPay')}}" method="post">
                                @csrf
                                ...
                                <input type="text" hidden name="mobile" value="{{ $billData['mobile'] ?? '' }}">
                                  <input type="text" hidden name="billNumber" value="{{ $billData['billNumber'] ?? '' }}">
                                  <input type="text" hidden name="customerParamsDetails" value="{{ $billData['customerParamsDetails'] ?? '' }}">
                                <input type="text" hidden name="geoCode" value="{{ $billData['geoCode'] ?? '' }}">

                                  @if ($billData['paymentAmountExactness']=="EXACT")
                                   <div class="mb-4">
                                <label for="billAmount" class="block text-sm font-medium ">Bill Amount*</label>
                                <input type="text" name="billAmount" value="{{ $billData['billAmount'] ?? '' }}" class="form-input mt-1 w-full p-1.5"  readonly id="billAmount" placeholder="Enter Consumer Number">
                            </div>
                            @else
                                <div class="mb-4">
                                <label for="billAmount" class="block text-sm font-medium ">Bill Amount*</label>
