            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg" style="background: linear-gradient(to right, #0a22aa, #b62512); color: white; border: none;">
                        <strong style="color: white;">Water Bill</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('waterBillFetch')}}" method="post">
                            @csrf
                          
                            <div class="mb-4">
                                <label for="mobile-number" class="block text-sm font-medium "> Customer Water Account Number *</label>
                                <input type="text" name="waterNumber" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="mobile-number" placeholder="Enter Water Account Number">
                            </div>
                ...
                <div class="bg-white shadow-lg rounded-lg">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-500">
                            ...
                            <form action="{{route('waterBillPay')}}" method="post">
                                @csrf
                                ...
                                <input type="text" hidden name="waterNumber" value="{{ $billData['waterNumber'] ?? '' }}">
