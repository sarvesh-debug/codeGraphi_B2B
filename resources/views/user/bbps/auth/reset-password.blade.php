...
<head>
    ...
    <title>Password Reset | CodeGraphi</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto flex flex-col items-center justify-center min-h-screen px-6">
        ...
        <div class="flex flex-col items-center text-center mb-8">
            <!-- Logo -->
            <img src="{{ asset('assets/img/icons/favicon.png') }}" style="border-radius: 50%;" alt="CodeGraphi Logo" class="w-20 h-20 mb-4">
            <h1 class="text-blue-600 text-4xl md:text-6xl font-bold">
                <span style="color: #ff0800">Code</span><span style="color: #0d0d0e">Graphi</span>
            </h1>
