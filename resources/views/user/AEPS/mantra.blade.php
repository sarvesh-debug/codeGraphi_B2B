...
<script language="javascript" type="text/javascript">
    ...
    var XML = '<?xml version="1.0"?>' +
        ...
        '<Opts ' +
            ...
            'env="' + $("#Env").val() + '" />' +
        DemoFinalString +
        '<CustOpts><Param name="mantrakey" value="' + $("#txtCK").val() + '" /></CustOpts>' +
        '</PidOptions>';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.body.classList.remove('blur-active'); // Remove blur after alert
        },
        error: function (jqXHR, ajaxOptions, thrownError) {
            alert(thrownError); // Show error message
            document.body.classList.remove('blur-active'); // Remove blur on error too
        }
    });
}
