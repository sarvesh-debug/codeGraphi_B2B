            ...
            <div class="d-flex align-items-end row">
                ...
                <div class="card-body">
                    ...
                    @if($role==="distibuter")
                                ...
                                <h5 class="card-title  "><b>Welcome Distributor</b></h5>
                    ...
                    <span class="align-middle me-3 mb-2 mb-md-0"><b>e-Mail:</b>info@CodeGraphipvtltd.com</span>
	  ...
	  <div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-rechargee fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelMobileRecharge')}}">
						...
						<h3 class="card-title mb-2 mt-2 service-text">Mobile Recharge</h3>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-electricityy fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelElectricityBill')}}">
						<div class="card-title d-flex align-items-center justify-content-center">
		...
		<div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-insurancee fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelInsuranceBill')}}">
						<div class="card-title d-flex align-items-center justify-content-center">
		...
		<div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-insurancee fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelEmiBill')}}">
						<div class="card-title d-flex align-items-center justify-content-center">
							<i class="fas fa-hand-holding-usd fa-3x"></i>
						</div>
						<h3 class="card-title mb-2 mt-2 service-text">EMI</h3>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-gass fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelGasBill')}}">
						<div class="card-title d-flex align-items-center justify-content-center">
							<i class="fa-solid fa-bottle-droplet fa-3x" style="color: black"></i>
						</div>
						<h3 class="card-title mb-2 mt-2 service-text">Gas</h3>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-2 col-md-3 col-3 mb-4">
			<div class="card gradient-gass fixed-card">
				<div class="card-body">
					<a href="{{route('digifintelLpgBill')}}">
						<div class="card-title d-flex align-items-center justify-content-center">
							<i class="fas fa-gas-pump fa-3x"></i>
						</div>
						<h3 class="card-title mb-2 mt-2 service-text">LPG</h3>
					</a>
				</div>
			</div>
		</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelDthBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-satellite-dish fa-3x  "></i> <!-- DTH Icon -->
                </div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelWaterBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-tint fa-3x  "></i> <!-- DTH Icon -->
                </div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelLandlineBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-phone fa-3x  "></i> <!-- DTH Icon -->
                </div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelCableBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-tv fa-3x  "></i> <!-- DTH Icon -->
                </div>
                <h3 class="card-title mb-2 mt-2 service-text">Cable</h3>
            </a>
        </div>
    </div>
</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelMuncipalityBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-city fa-3x  "></i> <!-- DTH Icon -->
                </div>
                <h3 class="card-title mb-2 mt-2 service-text">Municipality</h3>
            </a>
        </div>
    </div>
</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelFastagBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-car fa-3x  "></i> <!-- DTH Icon -->
                </div>
                <h3 class="card-title mb-2 mt-2 service-text">Fastag</h3>
            </a>
        </div>
    </div>
</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelBroadbandBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-wifi fa-3x  "></i> <!-- DTH Icon -->
                </div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelDatacardPrepaidBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fas fa-sim-card fa-3x  "></i> <!-- DTH Icon -->
                </div>
                <h3 class="card-title mb-2 mt-2 service-text">Datacard Prepaid</h3>
            </a>
        </div>
    </div>
</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelDatacardPostpaidBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-sim-card fa-3x  " style="color: black"></i> <!-- DTH Icon -->
                </div>
                <h3 class="card-title mb-2 mt-2 service-text">Datacard Postpaid</h3>
            </a>
        </div>
    </div>
</div>
...
<div class="col-lg-2 col-md-3 col-3 mb-4">
    <div class="card gradient-waterr fixed-card"> <!-- You can rename class if needed -->
        <div class="card-body">
            <a href="{{ route('digifintelPostpaidBill') }}">
                <div class="card-title d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-mobile-button fa-3x" style="color: black"></i> <!-- DTH Icon -->
                </div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelMobileRecharge')}}">
					...
					<h3 class="card-title mb-2 service-textm">Mobile Recharge</h3>
				</a>
			</div>
		</div>
	</div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelElectricityBill')}}">
					...
					<h3 class="card-title mb-2 service-textm">Electricity</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelInsuranceBill')}}">
					...
					<h3 class="card-title mb-2 service-textm">Insurance</h3>
				</a>
			</div>
		</div>
	</div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelEmiBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-hand-holding-usd fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">EMI</h3>
				</a>
			</div>
		</div>
	</div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelGasBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-bottle-droplet fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Gas</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelLpgBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-gas-pump fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">LPG</h3>
				</a>
			</div>
		</div>
	</div>
	 ...
	 <div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelDthBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-satellite-dish fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">DTH</h3>
				</a>
			</div>
		</div>
	</div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelWaterBill')}}">
					...
					<h3 class="card-title mb-2 service-textm">Water Bill</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelLandlineBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-phone fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Landline</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelCableBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-tv fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Cable</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelMuncipalityBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-city fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Municipality</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelFastagBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-car fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Fastag</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelBroadbandBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-wifi fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Broadband</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelDatacardPrepaidBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-sim-card fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Datacard Prepaid</h3>
				</a>
			</div>
		</div>
	</div>
		...
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelDatacardPostpaidBill')}}">
					...
					<h3 class="card-title mb-2 service-textm">Datacard Postpaid</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="col-3 ">
		<div class=" ">
			<div class="card-body">
				<a href="{{route('digifintelPostpaidBill')}}">
					<div class="card-title d-flex align-items-center justify-content-center">
						<i class="fas fa-mobile-button fa-2xl mb-1"></i>
					</div>
					<h3 class="card-title mb-2 service-textm">Postpaid</h3>
				</a>
			</div>
		</div>
	</div>
