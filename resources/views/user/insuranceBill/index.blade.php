                ...
                <div class="bg-white shadow-lg rounded-lg w-full">
                    ...
                    <div class="p-6">
                        <form action="{{route('insuranceBillFetch')}}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label for="customer-id" class="block text-sm font-medium">Policy No *</label>
                                <input type="text" name="policyNo" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="customer-id" placeholder="Policy No">
                            </div>

                            <div class="mb-4">
                                <label for="cardNumber" class="block text-sm font-medium">Date of Birth (DD/MM/YYYY) *</label>
                                <input type="text" name="dob" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="cardNumber" placeholder="Date of Birth (DD/MM/YYYY)">
                            </div>

                            <div class="mb-4">
                                <label for="email-id" class="block text-sm font-medium">Email Id *</label>
                                <input type="email" name="email" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="email-id" placeholder="E-mail Id">
                            </div>
