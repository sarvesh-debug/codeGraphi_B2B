...
<div class="container-fluid px-4">
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">BBPS Statement</li>
    </ol>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{route('bbpsReport')}}" class="row align-items-end">
                <div class="col-md-5">
    ...
    <div class="card-body table-scroll">
        <table id="datatablesSimple" class="table table-bordered">
            ...
            <tbody>
                ...
                @php
                $data = json_decode($transaction->response_body, true);
                @endphp
                <tr>
                    ...
                    <td>
                        {{ $data['data']['billerDetails']['account'] ?? "Na" }}
                     
                    </td>
                    <td>{{$transaction->external_ref}}</td>
                    <td>
                    ...
                    <td>
                        @php
                            $responseData = json_decode($transaction->response_body);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <pre id="responseData{{ $transaction->id }}">{{ json_encode(json_decode($transaction->response_body), JSON_PRETTY_PRINT) }}</pre>
            </div>
