            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg">
                        <strong>Digifintel Mobile Recharge</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('digifintelMobileRechargePay')}}" method="post">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select mt-1 w-full" id="operator" name="operator">
                                    ...
                                    @foreach($operators as $operator)
                                        <option value="{{ $operator['productId'] }}">{{ $operator['displayName'] }}</option>
                                    @endforeach
</select>
                            </div>
                            <div class="mb-4">
