            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg">
                        <strong>Datacard Postpaid Recharge</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('digifintelDatacardPostpaidBillFetchParams')}}" method="post">
                            @csrf
                            <!-- <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select mt-1 w-full" id="operator" name="operator">
                                    ...
                                    @if (isset($operator['productId']) && isset($operator['displayName']))
                                        <option value="{{ $operator['productId'] }}">
                            ...
                            <button type="submit" class="btn btn-success  w-full text-primary bg-indigo-100 py-2 px-4 rounded-lg">Next</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white shadow-lg rounded-lg">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-500">
                            ...
                            <form action="{{route('pageNotFound')}}" method="post">
                                @csrf
