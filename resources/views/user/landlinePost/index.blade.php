            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg" style="background: linear-gradient(to right, #0a22aa, #b62512); color: white; border: none;">
                        <strong style="color:white;">Landline Bill</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('landlineBillFetch')}}" method="post">
                            @csrf
                          
                            <div class="mb-4">
                                <label for="mobile-number" class="block text-sm font-medium "> Customer Landline Number *</label>
                                <input type="text" name="landlineNumber" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="mobile-number" placeholder="Enter Landline Number">
                            </div>
                            <div class="mb-4">
                                ...
                                <select class="form-select mt-1 w-full" id="operator" name="operator">
                                    ...
                                    <option value="{{ $biller['billerId'] }}">{{ $biller['billerName'] }}</option>
                                @endforeach
                                </select>
                            </div>
                ...
                <div class="bg-white shadow-lg rounded-lg">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-500">
                            ...
                            <form action="{{route('landlineBillPay')}}" method="post">
                                @csrf
                                <input type="text"  name="enquiryReferenceId" value="{{ $billData['enquiryReferenceId'] ?? '' }}">
                                <input type="text" hidden name="billerId" value="{{ $billData['billerId'] ?? '' }}">
                                <input type="text" hidden name="landlineNumber" value="{{ $billData['landlineNumber'] ?? '' }}">
