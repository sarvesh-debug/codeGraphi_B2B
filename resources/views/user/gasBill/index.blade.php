            ...
            <div class="w-full lg:w-[45%] mb-4 flex justify-center align-center ">
                <div class="bg-white shadow-lg rounded-lg w-full">
                    <div class="bg-indigo-100 text-black p-4 rounded-t-lg" style="background: linear-gradient(to right, #0a22aa, #b62512); color: white; border: none;">
                        <strong style="color: white;">Gas Bill Payment</strong>
                    </div>
                    <div class="p-6">
                        <form action="{{route('gasRechargePay')}}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label for="customer-id" class="block text-sm font-medium "> Registered Mobile Number
                                    *</label>
                                    <input type="text" name="mobile" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="customer-id" placeholder="Registered Mobile Number">
                            </div>

                              <div class="mb-4">
                                <label for="customer-id" class="block text-sm font-medium "> Consumer Number
                                    *</label>
                                    <input type="text" name="param1" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="customer-id" placeholder="Consumer Number">
                            </div>

                             <div class="mb-4">
                                <label for="customer-id" class="block text-sm font-medium "> Distributor ID
                                    *</label>
                                    <input type="text" name="param2" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="customer-id" placeholder="Distributor ID">
                            </div>
                             <div class="mb-4">
                                <label for="customer-id" class="block text-sm font-medium "> Unique Consumer ID
                                    *</label>
                                    <input type="text" name="param4" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="customer-id" placeholder="Unique Consumer ID">
                            </div>
                            

         <div class="relative w-full mb-4">
                            <label for="operator-search" class="block text-sm font-medium">Select Provider *</label>
...
function selectBiller(id, name) {
 ...
 <div class="mb-4">
                                <label for="mobile-number" class="block text-sm font-medium "> Amount *</label>
                                <input type="text" name="billAmount" class="form-input mt-1 w-full p-1.5 border border-gray-300" id="mobile-number" placeholder="Enter Mobile Number">
                            </div>
                ...
                <div class="bg-white shadow-lg rounded-lg">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-500">
                            ...
                            <p>Terms and Condition 1.The price of refill cylinder indicated here is tentative. The price applicable on the date of delivery will be the final price.2. The amount paid now shall be treated as advance and will be adjusted against the actual refill price at the time of delivery.3. Excess amount if paid by you shall be refunded to you.4. If amount is paid less, then the differential amount to be paid to the delivery boy of the distributor at the time of delivery or electronically. 5. The final refill cost will be provide on the cash memo.6. The delivery is deemed complete when the cylinder is given to the person at the consumers premises and signature obtained. No dispute will be entertained in this regard.7. In case the refill could not be delivered at the residence of the consumer due to various reasons or booking cancelled by the consumer, the amount paid would be refunded / adjusted against the next booking.</p>
                            @if (session('data'))
